...
.h202[
- Il filo conduttore delle tre storie sara' lo studio dei funghi]
...
.pull-left[
.center[.font120[Mycoambinarnavirus]]
.center[.font100[.grey[Phylum Lenarviricota]]]

.par30[
- Nuovi narnavirus con genoma ambisenso

- Raggruppati filogeneticamente in un unico clade

- Funzione di rORF e' sconosciuta
]
]
...
.h202[
- Il secondo esempio di virus identificati e' un sottogruppo dei narnavirus con un' organizzazione genomica particolare

- Presentano una seconda ORF antisenso di funzione sconosciuta
- Filogeneticamente fanno parte dello stesso clade
- Sono stati identificati anche da altri autori
]
